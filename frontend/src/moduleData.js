...
function module3() {
    ...
    const sixthComment = "\"\"\"\n- While |tyzarStrength| is greater than 1, do the following:\n- If |tyzarAttack| is equal to \"Fire\", print\n|blockFireSpell|.\n- If |tyzarAttack| is equal to \"Hit\", print\n|shieldSpell|.\n- Otherwise, print |castSpell|.\n- Set |tyzarStrength| to |tyzarStrength| minus 1.\n- After the while loop finishes, print |youDefeatedTyzar|.\n\"\"\"\ndef taskSix(tyzarStrength, tyzarAttack, blockFireSpell, shieldSpell, castSpell, youDefeatedTyzar):\n  # Place your code below this line\n  ";
